...
'''
boomheights = [12] # feet, convert to m below
extents = [0.0, 0.5, 1.0]
wind_speeds = [2] # mph, convert to m below
diamvs = [50]
dmass = 1
    ...
    for extent in extents:
        for wind_speed in wind_speeds:
            for diamv in diamvs:
                ...
                control.initializeControl(acraft.lmvel, acraft.s,
                                          terrain.zref)  # line 155 Aginit.for sets ldry, line 274:swath; lines 303-329
                ...
                data = (xdata, ydata, zdata, tdata)
                # filename = str(int(diamv)) + '_' + str(round(extent,2)) + '_' + str(int(wind_speed)) + '_' + str(int(boomheight))
